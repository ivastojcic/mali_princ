      ...
      <main>
        <div class="container">
          ...
          <div class="alert alert-warning" role="alert">
            <h4 class="alert-heading">Niste naš član?</h4>
            <p>Registrirajte se besplatno kako biste mogli preuzeti naše knjige</p>
            <hr>
            <p class="mb-0">Možete se prijaviti <a href="login.php">Ovjde</a></p>
          </div>
          ...
          <div class="row">
            <div
              ...
              :key="book.id"
            >
              <Book :book="book" :member="false"></Book>
            </div>
